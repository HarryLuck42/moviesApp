...
class MoviesNowPlayingViewModel @ViewModelInject constructor(val moviesRepository: MoviesRepository,
    ...
    fun getListData(api_key: String, page:String, language:String,
        ...
        scope.launch {
            try {
                val result = moviesRepository.getMoviesData(Const.NOW_PLAYING_PATH, api_key, page, language,
