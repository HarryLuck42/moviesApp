...
import com.corp.luqman.movielisting.data.remote.response.ErrorResponse
...
class NetworkHelper {
    ...
    fun getErrorMessage(throwable: Throwable): String {
        ...
        val message = when (throwable) {
            ...
            is java.lang.Exception ->  throwable.message.toString()
    ...
    private fun getMessageDetail(
        ...
        when (statusCode) {
            ...
            HttpURLConnection.HTTP_CONFLICT -> message =
                "Conflict,\nIndicates that the request could not be processed because of conflict in the request,\nsuch as an ic_edit conflict in the case of multiple updates."
    ...
    private fun getSubErrorMessageDetail(
        ...
        try {
            if (errorBody != null) {
                val errorRes = Helpers.getDefaultMoshi().adapter(ErrorResponse::class.java)
